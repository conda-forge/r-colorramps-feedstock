About r-colorramps-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-colorramps-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1043&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-colorramps-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-colorramps` can be installed with `conda`:
...
```
mamba install r-colorramps
```

It is possible to list all of the versions of `r-colorramps` available on your platform with `conda`:
...
```
mamba search r-colorramps --channel conda-forge
```
...
mamba repoquery search r-colorramps --channel conda-forge

# List packages depending on `r-colorramps`:
mamba repoquery whoneeds r-colorramps --channel conda-forge

# List dependencies of `r-colorramps`:
mamba repoquery depends r-colorramps --channel conda-forge
```
